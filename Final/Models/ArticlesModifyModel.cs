...
namespace Final.Models
{
    ...
    {
        public ArticlesModifyModel() : base()
        {
            Core.DB _db = new Core.DB();
        }
        public ArticlesModifyModel(string _sessionId, DB _db) : base(_sessionId, _db)
        {
            Access = false;
        }
        public ArticlesModifyModel(string _sessionId, DB _db, RouteData _routes) : base(_sessionId, _db)
        {
        ...
        public ArticlesModifyModel(string _sessionId, DB _db, RouteData _routes, List<Tag> _tagList, string _subject, string _text) : base(_sessionId, _db)
        {
        ...
        public ArticlesModifyModel(string _sessionId, DB _db, RouteData _routes, string _subject, string _text) : base(_sessionId, _db)
        {
            var _access = AccessScripts.CheckAccess(_db, base.user, _routes);
            Article? _changedArticle = ArticleEntity.GetByid(_db, _routes.Values["id"].ToString()); //.Add(_db, _subject, _text, base.user);
            ArticleEntity.Update(_db, _changedArticle, _subject, _text);
