...
namespace Final.Models
{
    ...
    {
        public ArticlesDeleteModel() : base()
        {
            Core.DB _db = new Core.DB();
        }
        public ArticlesDeleteModel(string _sessionId, DB _db) : base(_sessionId, _db)
        {
            Access = false;
        }
        public ArticlesDeleteModel(string _sessionId, DB _db, RouteData _routes) : base(_sessionId, _db)
        {
