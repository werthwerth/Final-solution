...
namespace Final.Models
{
    ...
    {
        public UsersAllModel() : base()
        {
            Core.DB _db = new Core.DB();
        }
        public UsersAllModel(string _sessionId, DB _db) : base(_sessionId, _db)
        {
            Access = false;
        }
        public UsersAllModel(string _sessionId, DB _db, RouteData _routes) : base(_sessionId, _db)
        {
        ...
        {
            public Viewedusers(DB _db, User _user)
            {
