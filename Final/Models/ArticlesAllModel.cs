...
namespace Final.Models
{
    ...
    {
        public ArticlesAllModel() : base()
        {
            Core.DB _db = new Core.DB();
        }
        public ArticlesAllModel(string _sessionId, DB _db) : base(_sessionId, _db)
        {
            Access = false;
        }
        public ArticlesAllModel(string _sessionId, DB _db, RouteData _routes) : base(_sessionId, _db)
        {
