...
namespace Final.Models
{
    ...
    {
        public TagsAllModel() : base()
        {
            Core.DB _db = new Core.DB();
        }
        public TagsAllModel(string _sessionId, DB _db) : base(_sessionId, _db)
        {
            Access = false;
        }
        public TagsAllModel(string _sessionId, DB _db, RouteData _routes) : base(_sessionId, _db)
        {
        ...
        {
            public _viewedTags(DB _db, Tag _tag)
            {
                Id = _tag.Id;
                Text = _tag.Text;
