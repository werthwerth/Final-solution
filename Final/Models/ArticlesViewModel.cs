...
namespace Final.Models
{
    public class ArticlesViewModel : BaseModel
    {
        ...
        public ArticlesViewModel(string _sessionId, DB _db) : base(_sessionId, _db)
        {
            Access = false;
        }
        public ArticlesViewModel(string _sessionId, DB _db, RouteData _routes) : base(_sessionId, _db)
        {
        ...
        public ArticlesViewModel(string _sessionId, DB _db, RouteData _routes, string _commentText) : base(_sessionId, _db)
        {
            Access = AccessScripts.CheckAccess(_db, base.user, _routes);
            if (isLogged)
            {
